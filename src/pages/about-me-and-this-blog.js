        ...
        <motion.div initial="exit" animate="enter" exit="exit">
          ...
          <main>
            <section>
              ...
              <p>
                Đôi dòng tự sự với các bạn, phải nói rằng khoảng thời gian này
                vô cùng khó khăn, khi mà mọi thứ đều mới, nghỉ việc không có
                tiền, phải vay mượn sống qua ngày. "HTML là gì? CSS là sao ta?
                Ủa sao nhiều thứ học quá vậy? Web chạy thế nào? Từ từ anh ơi em
                mới học được tí JS à, anh nói em học VueJS là sao? Vue là cái gì
                vậy anh? Bạn em làm web nó khuyên học React. Thế túm lại là
                sao?"
              </p>
              <p>
                "Anh xin lỗi nhưng hiện tại anh đang thích tuyển mấy bạn thực
                tập trẻ trẻ chứ cỡ em già quá". "Chỗ anh tuyển phải biết
                fullstack em ơi, em biết SQL không? .NET thì sao?" Vân vân và
                mây mây.
              </p>
            </section>
            <section>
              ...
              <p>
                Mình muốn giúp bạn, để con đường đến với lập trình web của các
                bạn{' '}
                <b>
                  bớt chông gai, không lặp lại những sai lầm mình đã mắc phải
                </b>
                ...
                <b>bài viết dịch thuật</b>, ... mọi thứ mà mình biết và nghĩ là
            ...
            <section>
              ...
              <p></p>
              <div>
                Mình không thể nào hình dung nổi sẽ có một ngày mình có thể tự
                tạo cho mình một blog, làm những thứ đẹp đẽ và thú vị như thế
                này. Xin chân thành tỏ lòng biết ơn đến:
                <ul>
                  <li>
                    Anh Hoàn superman: người anh senior với kiến thức sâu rộng,
                    người đã chỉ bảo và truyền tinh thần 'Dám cho đi' của anh
                    đến với mọi người.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    cho tao :)). Cảm ơn vì đã bỏ công sức kiếm dự án freelance
                    đầu tay cho tao. Cảm ơn man đã dạy cho tao nhiều điều khác
                    biệt giữa lý thuyết và thực tế, về mindset làm việc khi bước
                    vào thế giới freelance.
                  </li>
                  <li>
